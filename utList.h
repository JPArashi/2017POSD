...
TEST(List, matchToNumberShouldFail) {
  ...
  Variable X("X");
  Atom terence_tao("terence_tao");
  vector<Term *> args = {&f, &X, &terence_tao};
  List l(args);
...
TEST(List, matchToSameListWithDiffVarNameShouldSucceed) {
  ...
  Variable Y("Y");
  Atom terence_tao("terence_tao");
  vector<Term *> args1 = {&f, &X, &terence_tao};
  List l1(args1);
  vector<Term *> args2 = {&f, &Y, &terence_tao};
  List l2(args2);
...
TEST(List, matchToVarToAtominListShouldSucceed) {
  ...
  vector<Term *> args1 = {&f, &X, &terence_tao};
  List l1(args1);
  vector<Term *> args2 = {&f, &s, &terence_tao};
  List l2(args2);
  EXPECT_TRUE(l1.match(l2));
